...
public static class PoiToonUIO
{
...
public class PoiToonOutline : ShaderGUI
{
  ...
  public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
  {
    ...
    // main section
    m_mainOptions = PoiToonUIO.Foldout ( "Main" , m_mainOptions);
    if (m_mainOptions)
    {
    ...
    // outline section
    m_outlineOptions = PoiToonUIO.Foldout ( "Outlines" , m_outlineOptions);
    ...
    // emissive section
    m_emissionOptions = PoiToonUIO.Foldout ( "Emission" , m_emissionOptions);
    ...
    // fake lighting
    m_fakeLightingOptions = PoiToonUIO.Foldout ( "Fake Lighting" , m_fakeLightingOptions);
    ...
    // Specular Highlights
    m_specularHighlightsOptions = PoiToonUIO.Foldout ( "Specular Highlights" , m_specularHighlightsOptions);
    ...
    // Rim Lighting
    m_rimLightOptions = PoiToonUIO.Foldout ( "Rim Lighting" , m_rimLightOptions);
    ...
    m_miscOptions = PoiToonUIO.Foldout ( "Misc" , m_miscOptions);
